...
class F1:
    ...
    @staticmethod
    def score(pos_examples:set = {}, neg_examples:set = {}, instances:set = {}):
        if len(instances) == 0:
            return 0.

        tp = len(pos_examples.intersection(instances))
        tn = len(neg_examples.difference(instances))
        fp = len(neg_examples.intersection(instances))
...
class Accuracy:
    ...
    @staticmethod
    def score(pos_examples:set = {}, neg_examples = {}, instances:set = {}) -> float:
